...
public abstract class BaseListController {
    ...
    private void renderList(JsonNode data) {
        ...
        boolean hasLocationFilter = !ignoreLocationFilter() && selectedLocation != null && !selectedLocation.equals("All") && !selectedLocation.isBlank();
    ...
    protected boolean ignoreLocationFilter() {
        return false;
    }
